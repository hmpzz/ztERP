...
Public Class T_JEYS_add_detail
    ...
    Private Sub Refresh_ExDataGridView_master(Optional ByVal s As String = "")
        ...
        sql = "SELECT a.*,case state when 0 then '新建' when 1 then '审核' when 2 then '结案' end as state1,a.project_money-SK_money as wSK_money " & _
                "FROM project_master a " & _
                "where SK_money<project_money and a.factory_code in (select c.factory_code " & _
