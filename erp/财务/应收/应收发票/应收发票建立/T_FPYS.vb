...
Public Class T_FPYS
    ...
    Private Sub ToolStripButton_add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton_add.Click
        Dim T_FPYS_add As New T_FPYS_add
        T_FPYS_add.state = "new"
        T_FPYS_add.billno = ""
        T_FPYS_add.Owner = Me
        T_FPYS_add.ShowDialog()
    ...
    Private Sub Refresh_ExDataGridView_master(Optional ByVal s As String = "")
        ...
        Me.ExDataGridView1.AddColumn("customer_name", "供应商名称")


        Me.ExDataGridView1.AddColumn("nsr_no", "纳税人识别号")
        Me.ExDataGridView1.AddColumn("at", "地址电话")
        Me.ExDataGridView1.AddColumn("khh_no", "开户行识别号")
    ...
    Private Sub ToolStripButton_mod_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton_mod.Click
        ...
        sql = "select count(*) from t_fpys_master where state=0 and billno='" & Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells(0).RowIndex).Cells("billno").Value & "' "
        sqlcmd.Connection = sqlcon
        sqlcmd.CommandText = sql
        ...
        T_FPYS_add.Owner = Me
        T_FPYS_add.state = "mod"

        T_FPYS_add.billno = Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells.Item(0).RowIndex).Cells("billno").Value
        T_FPYS_add.ShowDialog()
    ...
    Private Sub ToolStripButton_del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton_del.Click
        ...
        Try
            ...
            sql = "delete T_FPYS_master  where billno='" & Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells(0).RowIndex).Cells("billno").Value & "' "
            sqlcmd.CommandText = sql
            sqlcmd.ExecuteNonQuery()

            sql = "delete T_FPYS_detail  where billno='" & Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells(0).RowIndex).Cells("billno").Value & "' "
            sqlcmd.CommandText = sql
            sqlcmd.ExecuteNonQuery()
            mytrans.Commit()
