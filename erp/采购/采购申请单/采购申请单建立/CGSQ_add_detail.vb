Public Class CGSQ_add_detail
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If state = "new" Then
            Dim DR As DataRow = CType(Me.Owner, CGSQ_add).dt_p.NewRow
            ...
            DR("ID") = 0
            CType(Me.Owner, CGSQ_add).dt_p.Rows.Add(DR)

        ElseIf state = "mod" Then

            CType(Me.Owner, CGSQ_add).ExDataGridView1.Rows(CType(Me.Owner, CGSQ_add).ExDataGridView1.SelectedCells(0).RowIndex).Cells("memo").Value = Me.TextBox1.Text.Trim

            'CType(Me.Owner, CGSQ_add).ExDataGridView1.Rows(CType(Me.Owner, CGSQ_add).ExDataGridView1.SelectedCells(0).RowIndex).Cells("money").Value = Me.TextBox2.Text.Trim

            CType(Me.Owner, CGSQ_add).ExDataGridView1.Rows(CType(Me.Owner, CGSQ_add).ExDataGridView1.SelectedCells(0).RowIndex).Cells("name").Value = Me.TextBox3.Text.Trim
            'CType(Me.Owner, CGSQ_add).ExDataGridView1.Rows(CType(Me.Owner, CGSQ_add).ExDataGridView1.SelectedCells(0).RowIndex).Cells("price").Value = Me.TextBox5.Text.Trim
            CType(Me.Owner, CGSQ_add).ExDataGridView1.Rows(CType(Me.Owner, CGSQ_add).ExDataGridView1.SelectedCells(0).RowIndex).Cells("amount").Value = Me.TextBox4.Text.Trim
    ...
    Private Sub CGSQ_add_detail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If state = "new" Then
            Me.Text = "新增"
