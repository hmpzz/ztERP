...
Public Class purchase_warehouse
    ...
    Private Sub Refresh_ExDataGridView(Optional ByVal s As String = "")
        ...
        sql = "select a.* " & _
           "from  t_item a left join " & _
           " t_part b on a.item_code=b.item_code " & _
           "where (b.depot_code='" & depot_code & "' or b.depot_code is null) and a.stop=1 and (a.item_name like '%" & s & "%' or  a.item_standard  like '%" & s & "%' or a.item_code like '%" & s & "%') " & s1
