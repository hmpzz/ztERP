...
Public Class QRWC
    ...
    Private Sub QRWC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
"                           where a.id=-1"
    ...
    Private Sub ExDataGridView1_CellMouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles ExDataGridView1.CellMouseDown
        If Me.ExDataGridView1.SelectedCells.Count = 0 Then
            Me.确认完成ToolStripMenuItem.Enabled = False
        ...
        ElseIf Me.ExDataGridView1.Rows(e.RowIndex).Cells("state2").Value = "已完成" Then
            Me.确认完成ToolStripMenuItem.Enabled = True
            Me.完成回退ToolStripMenuItem.Enabled = False
    ...
    Private Sub 接单完成ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 确认完成ToolStripMenuItem.Click
        Dim sqlcon As New SqlConnection
        Dim sqlcmd As New SqlCommand
        Dim sqlad As New SqlDataAdapter
        ...
        ElseIf dt.Rows(0)("jd_state") = 1 Then
            MsgBox("该单据已接单，请检查后操作！", MsgBoxStyle.OkOnly, "提示")
            Exit Sub
        ...
        sql = "update  scd_master set jd_state=3,jd_date=getdate(),jd_man='" & rs_name & "' where billno='" & Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells(0).RowIndex).Cells("billno").Value & "'"
        sqlcmd.CommandText = sql
        sqlcmd.ExecuteNonQuery()

        'Refresh_ExDataGridView(Me.TreeView1.SelectedNode.Text)
        Me.ExDataGridView1.Rows(Me.ExDataGridView1.SelectedCells(0).RowIndex).Cells("state2").Value = "确认完成"
        ...
        MsgBox("确认完成成功！", MsgBoxStyle.OkOnly, "提示")
    End Sub
