...
Public Class t_outlay_add_project
    ...
    Private Sub ExDataGridView1_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles ExDataGridView1.CellContentDoubleClick
        Me.Owner.Tag = Me.ExDataGridView1.SelectedRows(0).Cells("project_no").Value
        Me.DialogResult = Windows.Forms.DialogResult.OK
        Me.Close()
    End Sub
