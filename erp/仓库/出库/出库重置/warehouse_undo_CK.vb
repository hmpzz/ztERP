    ...
    Private Sub undo()
        ...
        Try
            ...
            For i = 0 To Me.ExDataGridView1.Rows.Count - 1
                ...
                '出库单重置
                If Me.ComboBox4.Text.Trim = "12" Then '出库单（领料）
                    ...
                    If k = 0 Then
                        Throw New System.Exception("此单据没有审核，请查证后再操作！")

                    ElseIf k = 2 Then
                        Throw New System.Exception("此单据已经结案，请查证后再操作！")
                    ...
                    sqlcmd.CommandText = sql
                    sqlcmd.ExecuteNonQuery()
                ElseIf Me.ComboBox4.Text.Trim = "11" Then '出库单（移库）
