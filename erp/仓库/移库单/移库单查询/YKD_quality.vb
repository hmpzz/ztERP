...
Public Class YKD_quality
    ...
    Private Sub Refresh_TreeView(Optional ByVal s As String = "")
        ...
        s1 = " a.input_date >='" & Format(Me.DateTimePicker1.Value, "yyyy-MM-dd") & " 00:00:00' and  a.input_date <='" & Format(Me.DateTimePicker2.Value, "yyyy-MM-dd") & " 23:59:59' and " & s1 & s
    ...
    Private Sub Refresh_ExDataGridView(ByVal billno As String)
        ...
        sql = "SELECT a.*,case source when 0 then '手工' else '导入' end as LY, b.depot_name as CK_depot,c.depot_name as RK_depot,case a.state when 0 then '新建' when 1 then '审核' when 2 then '结案' end as check_state " & _
        ...
        Me.ExDataGridView1.AddColumn("LY", "单据来源")
        Me.ExDataGridView1.AddColumn("LL_billno", "对应领料单号")
