...
Public Class warehouse_question_RPT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "warehouse_question_RPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedwarehouse_question_RPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As warehouse_question_RPT = New warehouse_question_RPT
        rpt.Site = Me.Site
        Return rpt
    End Function
