...
Public Class supplier
    ...
    Public Sub Refresh_ExexDataGridView1(Optional ByVal s As String = "")
        ...
        sqlcon = getconn()
        If s = "" Then
            sql = "select * from t_supplier a where 1=1 " & ss & _
            " order by supplier_no"
        Else
            sql = "select * from t_supplier a where (supplier_name like '%" & s & "%' or supplier_no like '%" & s & "%') " & ss & _
                "order by supplier_no"
        End If
        ...
        If Me.ExDataGridView1.Rows.Count > 0 Then
            Me.ExDataGridView1.Rows(0).Cells("supplier_no").Selected = True
    ...
    Private Sub ToolStripButton_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton_save.Click
        ...
        Try
            If Me.TextBox2.Enabled = True Then '说明是新建
                sql = "INSERT INTO t_supplier ( fax,input_date,input_man,linkman,memo,stop,supplier_no,supplier_name,tel,NSR_no,address,KHH_no) values " & _
            ...
            Else
                ...
                sql = "update t_supplier set nsr_no='" & Me.TextBox8.Text.Trim & "',address='" & Me.TextBox9.Text.Trim & "',khh_no='" & Me.TextBox10.Text.Trim & "', supplier_name='" & Me.TextBox3.Text.Trim & "',fax='" & Me.TextBox6.Text.Trim & "',memo='" & Me.TextBox7.Text.Trim & "',tel='" & Me.TextBox5.Text.Trim & "',linkman='" & Me.TextBox4.Text.Trim & "',stop=" & IIf(Me.CheckBox1.Checked, 0, 1) & ",modify_man='" & rs_name & "',modify_date=getdate() where supplier_no='" & Me.TextBox2.Text.Trim & "'"
    ...
    Private Sub cellclick(ByVal index As Int32)
        ...
        sql = "select * from  t_supplier where supplier_no='" & Me.ExDataGridView1.Rows(index).Cells("supplier_no").Value & "'"
        ...
        Me.TextBox3.Text = dt.Rows(0)("supplier_name")
        Me.TextBox2.Text = dt.Rows(0)("supplier_no")
